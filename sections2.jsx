      ...
      <section className="sobre sec-pad" id="sobre">
        <div className="wrap sobre-grid">
          ...
          <div className="sobre-txt reveal d1">
            ...
            <p>
              A <strong>Ultra Portões Automáticos</strong> nasceu com o
              propósito de oferecer soluções seguras, modernas e duráveis para
              residências, empresas e condomínios. Com experiência no mercado e
              uma equipe especializada, buscamos entregar instalações de alta
              qualidade, atendimento transparente e suporte técnico confiável.
            </p>
            <p style={{ marginTop: 14 }}>
              Nosso compromisso é garantir praticidade, segurança e
              tranquilidade para nossos clientes em cada projeto realizado.
            </p>
          ...
          <div className="form-card reveal d1">
            {sent ? (
              <div className="form-success">
                ...
                <p>
                  Abrimos o WhatsApp com seus dados. É só enviar a mensagem que
                  já vamos te responder.
                </p>
                <button
                  className="btn"
                  onClick={() => {
