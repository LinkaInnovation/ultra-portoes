// ============================================================
// Icon.jsx — robust, geometric line icons (24×24, currentColor stroke)
// ============================================================
...
export const Icon = {
  ...
  star: (p) => (
    <svg {...S({ ...p, fill: "currentColor", strokeWidth: 0 })}>
      <path d="m12 2 2.9 6.1 6.6.9-4.8 4.7 1.2 6.6L12 18.1 6.1 21.3l1.2-6.6L2.5 9.9l6.6-.9z" />
    </svg>
  ),
  mapPin: (p) => (
    <svg {...S(p)}>
  ...
  facebook: (p) => (
    <svg {...S(p)}>
      <path d="M14.5 8.5h2.5V5h-2.5A3.5 3.5 0 0 0 11 8.5V11H8.5v3.5H11V21h3.5v-6.5H17l.5-3.5h-3V8.8c0-.3.2-.3.5-.3Z" />
    </svg>
  ),
  // ---- service icons ----
  install: (p) => (
    <svg {...S(p)}>
      ...
      <path d="M3 9h18M7 4v16M11 4v16M15 4v16M19 4v16" />
    </svg>
  ),
  automate: (p) => (
    <svg {...S(p)}>
      <path d="M12 12a0 0 0 0 0 0 0" />
  ...
  shieldCheck: (p) => (
    <svg {...S(p)}>
      <path d="M12 3 5 6v5.5c0 4.3 3 7.4 7 8.5 4-1.1 7-4.2 7-8.5V6Z" />
      <path d="m9 11.5 2 2 4-4" />
    </svg>
  ),
  wrench: (p) => (
    <svg {...S(p)}>
      <path d="M15.5 5.5a4 4 0 0 0-5.3 5.1l-6 6a1.5 1.5 0 0 0 2.1 2.1l6-6a4 4 0 0 0 5.1-5.3l-2.2 2.2-2.1-.3-.3-2.1Z" />
    </svg>
  ),
  cpu: (p) => (
    <svg {...S(p)}>
  ...
  building: (p) => (
    <svg {...S(p)}>
      ...
      <path d="M4 21h16M8.5 9h0M11.5 9h0M14.5 9h0M8.5 13h0M11.5 13h0M14.5 13h0M9.5 21v-4h3v4" />
    </svg>
  ),
  // ---- differentiators ----
  award: (p) => (
  ...
  google: (p) => (
    <svg viewBox="0 0 24 24" width={p?.width || 24} height={p?.height || 24}>
      <path
        fill="#4285F4"
        d="M21.6 12.2c0-.6 0-1.2-.2-1.8H12v3.4h5.4a4.6 4.6 0 0 1-2 3v2.5h3.2c1.9-1.7 3-4.3 3-7.1Z"
      />
      <path
        fill="#34A853"
